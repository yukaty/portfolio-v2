...
const featuredExperiences = [
  {
    ...
    period: 'Current',
    description:
      'Design and develop production-oriented full-stack courses. Oversee code and content reviews across curricula, maintaining engineering standards and consistency.',
    tech: ['System Design', 'Code Review', 'Engineering Best Practices'],
  },
  {
    ...
    description:
      'Engineered backend operations for a loyalty platform serving 60 million users, including secure payment and settlement. Migrated legacy monoliths to microservices.',
    tech: ['Full-Stack Architecture', 'Microservices', 'Scalability'],
  },
];
