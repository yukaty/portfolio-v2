...
export const Hero: React.FC = () => {
    const fullText = "Hi! I'm Yuka's AI assistant. Ask me about her skills, experience, or projects — I'm happy to help!";
    const displayText = useTypewriter(fullText);

    return (
        <section className="min-h-screen pt-24 pb-12 flex items-center justify-center bg-cream overflow-hidden px-6 relative">
            {/* Background Decor */}
