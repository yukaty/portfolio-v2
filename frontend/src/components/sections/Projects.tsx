...
const projects = [
  {
    title: 'Portfolio V2',
    description:
      'AI-powered portfolio focused on RAG (Retrieval-Augmented Generation) transparency. Features to ensure LLM reliability.',
  ...
  },
  {
    ...
    description:
      'Automated news aggregator that tracks and summarizes technology trends using AI. Features vector search for finding historical trend data.',
