...
export const Footer: React.FC = () => {
    return (
        <footer id="contact" className="bg-navy-900 py-20 text-cream-50 border-t-2 border-border-primary transition-colors duration-300">
            <div className="container mx-auto px-6 text-center">
                ...
                <div className="flex justify-center gap-6 mb-10">
                    <a
                        ...
                        aria-label="GitHub"
                    >
                        <Github size={28} className="text-white group-hover:scale-110 transition-transform duration-md-short" />
                    </a>
                    <a
                        ...
                        aria-label="LinkedIn"
                    >
                        <Linkedin size={28} className="text-white group-hover:scale-110 transition-transform duration-md-short" />
                    </a>
                </div>
